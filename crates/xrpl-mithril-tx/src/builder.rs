...
//! use xrpl_mithril_types::{AccountId, Amount, XrpAmount};
//!
...
use xrpl_mithril_models::transactions::wrapper::UnsignedTransaction;
use xrpl_mithril_models::transactions::{
    self, Memo, Transaction, TransactionCommon,
};
use xrpl_mithril_types::{AccountId, Amount, Hash256, IssuedAmount, XrpAmount};
...
///
/// ```
/// use xrpl_mithril_tx::builder::TrustSetBuilder;
/// use xrpl_mithril_types::{IssuedAmount, IssuedValue, CurrencyCode};
///
/// # fn example() -> Result<(), Box<dyn std::error::Error>> {
...
///
/// ```
/// use xrpl_mithril_tx::builder::OfferCreateBuilder;
/// use xrpl_mithril_types::{Amount, XrpAmount, IssuedAmount, IssuedValue, CurrencyCode};
///
/// # fn example() -> Result<(), Box<dyn std::error::Error>> {
/// let issuer = "rPT1Sjq2YGrBMTttX4GZHjKu9dyfzbpAYe".parse()?;
///
...
///
/// ```
/// use xrpl_mithril_tx::builder::EscrowCreateBuilder;
...
pub struct EscrowCreateBuilder {
    ...
    condition: Option<xrpl_mithril_types::Blob>,
    destination_tag: Option<u32>,
}
...
impl EscrowCreateBuilder {
    ...
    #[must_use]
    pub fn condition(mut self, condition: xrpl_mithril_types::Blob) -> Self {
...
///
/// ```
/// use xrpl_mithril_tx::builder::AmmCreateBuilder;
/// use xrpl_mithril_types::{Amount, XrpAmount, IssuedAmount, IssuedValue, CurrencyCode};
///
/// # fn example() -> Result<(), Box<dyn std::error::Error>> {
/// let issuer = "rPT1Sjq2YGrBMTttX4GZHjKu9dyfzbpAYe".parse()?;
