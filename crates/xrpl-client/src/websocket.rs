...
//!
//! ```no_run
//! use xrpl_client::{WebSocketClient, Client};
...
use xrpl_models::requests::XrplRequest;
...
impl WebSocketClient {
    ...
    ///
    /// You must also send a [`SubscribeRequest`](xrpl_models::requests::subscription::SubscribeRequest)
