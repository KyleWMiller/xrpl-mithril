...
///
/// ```
/// use xrpl_mithril_models::requests::NftInfoRequest;
/// use xrpl_mithril_types::Hash256;
///
...
///
/// ```
/// use xrpl_mithril_models::requests::NftBuyOffersRequest;
/// use xrpl_mithril_types::Hash256;
///
...
///
/// ```
/// use xrpl_mithril_models::requests::NftSellOffersRequest;
/// use xrpl_mithril_types::Hash256;
///
...
///
/// ```
/// use xrpl_mithril_models::requests::NftHistoryRequest;
/// use xrpl_mithril_types::Hash256;
///
