...
//! It integrates with [`xrpl_mithril_codec::signing`] for hash computation and
//! serialization.
//!
//! # Signing Flow
//!
...
///
/// ```
/// use xrpl_mithril_wallet::{Wallet, Seed, Algorithm, sign};
///
...
pub fn sign(
    ...
    xrpl_mithril_codec::serializer::serialize_json_object(&signed_tx, &mut blob_buf, false)?;
...
///
/// ```
/// use xrpl_mithril_wallet::{Wallet, Seed, Algorithm, multi_sign};
///
/// let seed = Seed::from_passphrase("masterpassphrase");
/// let wallet = Wallet::from_seed(&seed, Algorithm::Secp256k1).unwrap();
///
...
///
/// ```
/// use xrpl_mithril_wallet::{Wallet, Seed, Algorithm, multi_sign, combine_signatures};
///
